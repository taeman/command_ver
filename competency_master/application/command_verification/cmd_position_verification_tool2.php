...
echo $sqlCond = "SELECT cmd_condition.*,cmd_position_match_condition.cond_id,cmd_position_match_condition.period,cmd_position_match_condition.match_id 
            ...
            WHERE  cmd_position_radub.letter_type = '".$rows_command[letter_type]."' AND
					...
					$me53
			ORDER BY cmd_position_match_condition.order_by";
...
<div class="r"></div>
  ...
  <div class="t"><label id="success<?=$i?>"><img src="img/loading1.gif" align="absmiddle"></label>&nbsp;<font color="#000000" style="text-shadow: #ffffff 0.1em 0.1em 0.2em;"><?=$rowsCond['cond_name']?></font></div>
...
<?php
  if($_GET['debug'] == 'on'){
    echo "Education : ".$eduId;
    echo "Group ID  : ".$rowsCond['gcond_id'];
  }
 ...
 echo "<hr>";
 echo "A".$idcard."<br>";
 echo "B".$rows_detail['attach_id']."<br>";
 echo "C".$rowsCond['cond_eval']."<br>";
 echo "D".$rowsCond['period']."<br>";
 echo "E".$eduId."<br>";
 echo "F".$rows_detail['level_id_new']."<br>";
 echo "<hr>";
 */
 ...
 if($result){
   ...
   $txt = "<img src=\"images/accept.png\" align=\"absmiddle\" />&nbsp;<font color=\"#275980\"><b>ผ่านเงื่อนไข $eduName</b></font>";
   echo "<script>document.getElementById('success".$i."').innerHTML = '<img src=\"images/accept.png\" align=\"absmiddle\" />';</script>";  
 }else{
   ...
   $txt = "<img src=\"images/error.png\" align=\"absmiddle\" />&nbsp;<font color=\"#FF0000\"><b>ไม่ผ่านเงื่อนไข</b></font>".$help_txt.$warning;
   echo "<script>document.getElementById('success".$i."').innerHTML = '<img src=\"images/error.png\" align=\"absmiddle\" />';</script>";
 }
...
?>
  <br />
  <div style="border:1px solid #00274F; border-style:dashed; background-color: #aecde4; color:#FFFFFF; padding:3px;">
 &nbsp;<?=$txt?>
  </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td valign="top">&nbsp;</td>
    <td><input name="bt_save_result" type="submit" value="  บันทึกผลการตรวจสอบ  " /></td>
  </tr>
</table>
<?php //@end?>
</form>
