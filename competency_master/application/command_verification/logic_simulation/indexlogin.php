...
<DIV class="menu_bar">
    <ul>
    <li><a href="javascript:linkMainPage('variable.php');">หน้าหลัก</a></li>
    <li><a href="javascript:linkMainPage('variable.php');">สร้างตัวแปร</a></li>
    <li><a href="indexlogin.php">สร้างตรรกะการตรวจสอบ</a></li>
