<?php
/**
* @comment ตรวจสอบการปรับปรุงตำแหน่งประเภททั่วไป ระดับชำนาญงาน
...
class checkImproveGeneralPosition extends utility{
	public $position_id;
	public $pid_old;
	...
	public function showExp(){
		...
		echo "<font color=\"#6A3500\"><b>ข้อเสนอแนะ :</b> กรณีที่ข้าราชการครูและบุคลากรทางการศึกษา ตำแหน่งบุคลากรทางการศึกษาอื่น 38 ค.(2) ตำแหน่งประเภททั่วไป ระดับชำนาญงานที่เป็นตำแหน่งว่าง และมีอัตราเงินเดือนให้เป็นระดับปฎิบัติงาน หรือชำนาญงานเพื่อใช้ในการบรรจุและแต่งตั้งผู้สอบแข่งขันได้ที่ขั้นบัญชีไว้เท่านั้น<br>
