...
class expFrame extends utility{
  ...
  public function __construct($dateStart="",$dateStart2="",$siteId="",$noPosition="",$positionId="",$levelId=""){
 ...
 */
  public function showExp(){
   switch($this->errCode){
	...
	break;
	case '1':
	 echo "การเลื่อนไม่ตรงกรอบ <br><font color=\"#000000\"><b><u><em>ข้อแนะนำ</em></u></b> กรุณาตรวจสอบกรอบอัตรากำลังเพิ่มเติม ว่าเป็นไปตามมาตรการจูงใจหรือไม่ หรือขอเป็นกรณีพิเศษเฉพาะรายโดยอนุมัติ ก.ค.ศ</font>";
	break;
	case '2':
