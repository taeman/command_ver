<?php
/**
* @comment class ตรวจสอบกรณีเงินเดือนไม่ตรงผัง
...
class checkSalaryFalse extends utility{
	
		public function __construct($radub_name='',$money_befor=''){
			$this->debug = "off";
			$this->radub_name = $radub_name;
		...
		public function checkExp(){
			...
			if($this->salary->check($this->radub_name,$this->money_befor,date("Y-m-d")) == true){ # เงินเดือนถูกต้อง
				return true;				
			}else{
				return false;	
			}
		...
		public function showExp(){
			...
			echo '<div style="border:1px solid #006600; border-style:dashed; background-color:#aecde4;padding:5px;text-align: left;"><font color="#000000">';
             	echo "<font color=\"#6A3500\"><b>ข้อเสนอแนะ :</b>ให้ตรวจสอบกรณีเงินเดือนไม่ตรงผัง</font>";
          	 	echo '</div>';
		}
...
class salary_level{
    ...
    function  salary_level($radub="",$money="",$xdate=""){
