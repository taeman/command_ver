...
* @created 22/01/2015
*/
class checkStudyOT45 extends utility{
		...
		public function showExp(){
			...
			echo '<div style="border:1px solid #006600; border-style:dashed; background-color:#aecde4;padding:5px;text-align: left;"><font color="#000000">';
             	echo "<font color=\"#6A3500\"><b>ข้อเสนอแนะ :</b>ตรวจสอบการศึกษา ผู้ลาศึกษาจะต้องมีอายุน้อยกว่าหรือเท่ากับ 45 ปี นับถึงวันที่ 15 มิถุนายน ของปีที่เข้าการศึกษา</font>";
          	 	echo '</div>';
		}
