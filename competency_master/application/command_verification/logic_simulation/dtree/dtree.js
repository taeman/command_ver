...
function dTree(objName) {
	...
	this.icon = {
		man				: dtreepath + 'img/man.gif',
		girl				: dtreepath + 'img/girl.gif',
		user				: dtreepath + 'img/user1.gif',
		usergroup		: dtreepath + 'img/users.gif',
		root				: dtreepath + 'img/houses.gif',
		folder			: dtreepath + 'img/base.gif',
		folderOpen	: dtreepath + 'img/base.gif',
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (node.url) {
		str += '<a href="' + node.url + '" class="' + ((this.config.useSelection) ? ((node._is ? 'nodeSel' : 'node')) : 'node') + '" id="s' + this.obj + nodeId + '"';
